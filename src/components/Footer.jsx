...
export default function Footer({ t }) {
  ...
  // 🛡️ VALIDACIÓN CRÍTICA: Si 't' es undefined, no renderiza nada y evita el crash.
  if (!t) {
    return null; 
  }
        ...
        <div className="flex flex-col items-center">
          ...
          <div className="text-center space-y-2">
            <p className="text-slate-400 text-sm">
              © {currentYear} <span className="text-white font-bold">Oscar Blanco</span>. {t.rights || "All rights reserved."}
            </p>
            <p className="text-slate-600 text-[10px] uppercase tracking-[0.4em] font-bold">
              {t.developed || "Developed by Oscar Blanco"}
            </p>
          </div>
